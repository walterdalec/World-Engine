...
type Props = {
    ...
    onClick?: (_x: number, _y: number, _canvas: HTMLCanvasElement) => void;      // click handler
    onHover?: (_x: number, _y: number, _canvas: HTMLCanvasElement) => void;      // hover handler
